# Requirements & Specifications — PaySick v1.3.4
...
| MKT-05 | Dashboard "Apply for Funding" link must navigate to marketplace-apply.html, not onboarding.html | Must Have — fixed v1.3.3 |
