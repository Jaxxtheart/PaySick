# Requirements & Specifications — PaySick v1.3.1
...
| PROV-05 | Provider registration application | Must Have |
...
| SEC-08 | Database pool errors must be logged but must NOT call process.exit() in serverless | Must Have — added v1.3.1 |
