 ...
 * @returns {object}
 */
function mergeCareSummary(existing, extracted) {
...
function nextQuestion(summary) {
  ...
  if (missing.includes('quotedAmountCents')) {
    return "Upload the quote if you have it, or tell me the quoted amount — I'll use it to work out the likely shortfall.";
  }
